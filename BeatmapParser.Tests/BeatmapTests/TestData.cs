...
public static class TestData
{
    ...
    public static readonly string ReallyComplexBeatmap = LoadReallyComplexBeatmap();

    private static string LoadReallyComplexBeatmap()
    {
        string fileName = "really_complex_beatmap.osu";
        ...
        if (!string.IsNullOrEmpty(assemblyLocation))
        {
            ...
            path = System.IO.Path.Combine(dir, "Resources", fileName);
            if (System.IO.File.Exists(path))
                return System.IO.File.ReadAllText(path);
        }
