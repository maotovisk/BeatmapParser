...
using BeatmapParser.Events.Commands;
using BeatmapParser.Sections;

namespace BeatmapParser.Helpers;
...
public partial class Helper
{
    ...
    /// <summary>
    /// Parses a string line into an implementation of <seeEventsSectionSection.Commands.ICommand"/> based on the command type.
    /// </summary>
    /// <param name="line">The string representation of the command to parse.</param>
    /// <returns>An instance of <see cref="EventsSection.Commands.ICommand"/> corresponding to the parsed command type.</returns>
