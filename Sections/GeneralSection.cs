...
public class GeneralSection
{
    ...
    /// <summary>
    /// Creates a new <see cref="GeneralSection"/> section of a <see cref="Beatmap"/> with the provided values.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new <see cref="GeneralSection"/> section of a <see cref="Beatmap"/> with default values.
    /// </summary>
    ...
    /// <summary>
    /// Parses a list of General lines into a new <see cref="GeneralSection"/> class.
    /// </summary>
    /// <param name="section"></param>
    /// <returns>A populated <see cref="GeneralSection"/> instance parsed from the provided section lines.</returns>
    public static GeneralSection Decode(List<string> section)
    {
    ...
    /// <summary>
    /// Encodes the <see cref="GeneralSection"/> class into a string.
    /// </summary>
    ...
    public string Encode()
    {
        ...
        foreach (var prop in typeof(GeneralSection).GetProperties())
        {
