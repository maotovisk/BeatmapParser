...
public class Spinner : HitObject
{
    ...
    private Spinner(Vector2 coordinates, double timeMilliseconds, HitObjectType type, (HitSounds.HitSample, List<HitSound>) hitSounds, bool newCombo, uint comboOffset, double endMilliseconds)
