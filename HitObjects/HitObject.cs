...
public class HitObject : IHitObject
{
    ...
    /// </summary>
    public (HitSounds.HitSample SampleData, List<HitSound> Sounds) HitSounds { get; set; }
    ...
    protected HitObject(Vector2 coordinates, double timeMilliseconds, HitObjectType type, (HitSounds.HitSample, List<HitSound>) hitSounds, bool newCombo, uint comboOffset)
    {
    ...
    protected HitObject(Vector2 coordinates, TimeSpan time, HitObjectType type, (HitSounds.HitSample, List<HitSound>) hitSounds, bool newCombo, uint comboOffset)
    ...
    protected HitObject()
    {
        ...
        _timeMilliseconds = 0;
        HitSounds = (new HitSounds.HitSample(), []);
        NewCombo = false;
        ComboOffset = 0;
    }
    ...
    public string Encode()
    {
        ...
        builder.Append($"{Helpers.Helper.FormatTime(_timeMilliseconds)},");
        ...
        builder.Append($"{type},");
        builder.Append($"{Helpers.Helper.EncodeHitSounds(HitSounds.Sounds)} ,".Replace(" ", string.Empty));
