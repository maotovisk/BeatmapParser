...
public class DifficultySection
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DifficultySection"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Converts a list of strings to a <see cref="DifficultySection"/> object.
    /// </summary>
    /// <param name="section"></param>
    /// <returns></returns>
    public static DifficultySection Decode(List<string> section)
    {
    ...
    /// <summary>
    /// Encodes the <see cref="DifficultySection"/> section into a string.
    /// </summary>
    /// <returns></returns>
    public string Encode()
    {
       ...
       foreach (var property in typeof(DifficultySection).GetProperties())
        {
            var value = property.GetValue(this);
            if (value is null) continue;
            
            if (value is string str && string.IsNullOrEmpty(str) && Helpers.Helper.FormatVersion == 128) continue;
