...
public class MetadataSection
{
    ...
    private MetadataSection(string title, string titleUnicode, string artist, string artistUnicode, string creator,
    ...
    /// <summary>
    /// Parses the Metadata section of the beatmap into a new <see cref="MetadataSection"/> class
    /// </summary>
    /// <param name="section"></param>
    /// <returns></returns>
    public static MetadataSection Decode(List<string> section)
    {
    ...
    public string Encode()
    {
        ...
        foreach (var prop in typeof(MetadataSection).GetProperties())
        {
            ...
            if (prop.Name == "BeatmapSetID" && BeatmapSetID == -1 && Helpers.Helper.FormatVersion == 128)
                continue;
            
            if (prop.Name == "BeatmapID" && BeatmapID == 0 && Helpers.Helper.FormatVersion == 128)
                continue;
