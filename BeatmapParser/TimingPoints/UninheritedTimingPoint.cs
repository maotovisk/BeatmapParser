...
public class UninheritedTimingPoint : TimingPoint
{
    ...
    {
        return $"{Helpers.Helper.FormatTime(TimeMilliseconds)},{BeatLength.ToString("G", CultureInfo.InvariantCulture)},{TimeSignature},{(int)SampleSet},{SampleIndex},{Volume},{1},{Helpers.Helper.EncodeEffects(Effects)}";
    }
